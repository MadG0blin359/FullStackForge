  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
        ...
        <motion.h1
          variants={fadeInUp}
          className="py-4 text-5xl lg:text-8xl font-semibold tracking-tight bg-gradient-to-b from-neutral-50 via-neutral-300 to-neutral-700 bg-clip-text text-transparent"
        >
        ...
        <motion.div variants={fadeInUp} className="max-sm:pb-0 py-10">
          <p className="text-gray-400 text-center mb-8">
            {HERO_CONTENT.trustedByText}
          </p>
          <motion.div
            variants={fadeInUp}
            className="flex flex-wrap justify-center max-sm:gap-4 gap-8"
          >
