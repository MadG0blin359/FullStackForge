...
const KeyFeatures = () => {
  const containerVariants = {
    ...
    visible: {
      ...
      transition: {
        staggerChildren: 0.2,
        when: "beforeChildren", // Complete parent's own animation first - from opacity: 0 to opacity: 1 before starting the staggered animation
      },
    },
  };
    ...
    <section>
      <div className="max-w-7xl mx-auto px-4 mt-20">
        <div className="text-center mb-12 border-t border-neutral-800">
          <h2 className="text-3xl lg:text-5xl mt-20 tracking-tight bg-gradient-to-t from-neutral-50 via-neutral-300 to-neutral-600 bg-clip-text text-transparent">
